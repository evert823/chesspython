...
print(datetime.now())
TestCastle(mychessgame, "maingame", "01A_castle_white_01")
TestMove(mychessgame, "maingame", "01A_castle_white_02", "King", (4, 0, 6, 0), True)
TestMove(mychessgame, "maingame", "01A_castle_white_03", "King", (4, 0, 2, 0), True)
TestCastle(mychessgame, "maingame", "01B_castle_black_01")
TestMove(mychessgame, "maingame", "01B_castle_black_02", "King", (4, 7, 6, 7), True)
TestMove(mychessgame, "maingame", "01B_castle_black_03", "King", (4, 7, 2, 7), True)
...
TestNoCastle(mychessgame, "maingame", "01I_nocastle_white_01")
TestNoCastle(mychessgame, "maingame", "01I_nocastle_white_02")
TestNoCastle(mychessgame, "maingame", "01J_nocastle_black_01")
TestNoCastle(mychessgame, "maingame", "01J_nocastle_black_02")
